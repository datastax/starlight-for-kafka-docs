...
Starlight for Kafka can run Apache Kafka(R) Streams applications with minimal configuration changes.
This guide explains how to make those changes, and it provides an example Java application to try out Kstreams with Starlight for Kafka.
