...
:page-aliases: docs@starlight-for-kafka::starlight-kafka-configuration.adoc
...
* xref:operations:starlight-kafka-implementation.adoc[{product_name} Implementation]
* xref:operations:starlight-kafka-monitor.adoc[Monitor {product_name}]
* xref:operations:starlight-kafka-security.adoc[{product_name} Security]
* xref:operations:starlight-kafka-proxy.adoc[{product_name} Proxy]
* xref:operations:starlight-kafka-schema-registry.adoc[{product_name} Schema Registry]