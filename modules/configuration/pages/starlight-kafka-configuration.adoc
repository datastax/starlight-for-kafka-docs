...
[NOTE]
====
Currently, Starlight for Kafka does not check the maximum byte limit. Therefore, if the value is too great, the response size may be over the network limit.
====
|5
|===
