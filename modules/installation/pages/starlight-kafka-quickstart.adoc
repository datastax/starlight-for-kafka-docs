...
You can configure this behavior and other xref:configuration:starlight-kafka-configuration.adoc[{product} parameters] in the xref:installation:attachment$values.yaml[Helm chart].
+
...
You can configure this behavior and other xref:configuration:starlight-kafka-configuration.adoc[{product} parameters].
+
