...
//Combine w/ configure and test sections on starlight-kafka-quickstart.adoc.
...
+
--
To use {product} with self-managed or standalone {pulsar-short} clusters, see xref:starlight-for-kafka:installation:starlight-kafka-quickstart.adoc[].
--
======
